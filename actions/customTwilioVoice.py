...
class TwilioVoiceInput(InputChannel):
    ...
    def _raise_invalid_speech_model_timeout_exception(self) -> None:
        ...
        raise InvalidConfigException(
            "If speech_timeout is 'auto' the speech_model must be 'numbers_and_commands'. "
            "Please update your speech_model to be 'numbers_and_commands' if you would like to continue "
